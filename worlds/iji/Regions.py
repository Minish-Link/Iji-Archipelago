...
sector1_regions = {
    "Sector 1 - Start",
    "Sector 1 - Poster", #Requires 2 Strength
...
sector2_regions = {
    ...
    "Sector 2 - Poster" # Poster room. Requires 4 strength, OR a machine gun, OR abusing I-Frames OoL
    }

sector3_regions = {
    "Sector 3 - Start",
    "Sector 3 - Restricted Area" # Contains 2 logbooks. Requires 10 crack, 10 strength, and a Nanofield Reboot
    "Sector 3 - Poster" # Contains a Poster. Requires 4 strength and 2 Health to rocket boost.
    }
...
sector4_regions = {
    ...
    "Sector 4 - Poster" # Contains the Poster. Logically requires a rocket launcher, but can be obtained itemless OoL
    }
...
sector6_regions = {
    "Sector 6 - Start",
    "Sector 6 - Poster" # Contains the poster. Requires the Velocithor V2-10 to access
    }
...
sector7_regions = {
    ...
    "Sector 7 - Poster", # Requires the CFIS (Passive Mode) and 3 Attack to open the door, and a Nuke to get across the gap
    }
...
sector8_regions = {
    ...
    "Sector 8 - Poster" # Requires a rocket boost from the nearby Trooper
    }

sector9_regions = {
    "Sector 9 - Start",
    "Sector 9 - Poster", # Requires an MPFB Devastator, 10 Health, and a lot of pain and suffering.
...
sectorx_regions = {
    ...
    "Sector X - Poster", # Requires using a Splintergun in the Ventilation Shaft (Or the Velocithor in a later part of the level, if you're feeling excessive)
